...
class TaskRVAdapter(val context: Context,
                    ...
                    val taskClickDeleteInterface: TaskClickDeleteInterface
                        ...
                        inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
                            val taskTV = itemView.findViewById<TextView>(R.id.idTextNoteTitle)
                            val timeTV = itemView.findViewById<TextView>(R.id.idTextTimeStamp)
                            val deleteTV = itemView.findViewById<ImageView>(R.id.idDeleteTask)
